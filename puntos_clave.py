...
#
    ...
    # Ajustes finales
    fig.update_layout(height=600,width=1200,title_text="Diagramas del ciclo",title_font=dict(size=16,family='Arial'),hovermode="closest",showlegend=False)
    st.plotly_chart(fig, use_container_width=True)

    #Análisis energético
    #st.markdown("<br>", unsafe_allow_html=True) 
        
    #st.markdown("<p style='font-size: 17px;'><strong>Análisis energético del ciclo</strong></p>", unsafe_allow_html=True)
    ...
    #st.markdown("<p style='font-size: 17px;'><strong>Análisis del compresor</strong></p>", unsafe_allow_html=True)
    ...
    #st.markdown("<p style='font-size: 17px;'><strong>Análisis de los evaporadores</strong></p>", unsafe_allow_html=True)
    ...
    # Ajustes finales
    fig2.update_layout(height=600,width=1200,title_text="",title_font=dict(size=16,family='Arial'),hovermode="closest",showlegend=False)
    ...
    #st.markdown("<p style='font-size: 17px;'><strong>Análisis del gas-cooler</strong></p>", unsafe_allow_html=True)
    ...
    #st.markdown("<p style='font-size: 17px;'><strong>Análisis de las válvulas electrónicas</strong></p>", unsafe_allow_html=True)
    ...
    #st.markdown("<p style='font-size: 17px;'><strong>Análisis del flash-tank</strong></p>", unsafe_allow_html=True)
...
#ANÁLISIS DEL CICLO
    ...
    tabla_propiedades_resumen.loc['Rendimiento electromecánico del compresor','Valores']=tabla_propiedades_compresor.loc['Rendimiento electromecánico','Valores']
...
def calculos_termodinamicos_sin_restricciones(eleccion,lista,puntos,df_analizador_redes_ensayo,df_equipo_ensayo,df_evaporador_04_ensayo,df_valvula_expansion_05_ensayo,df_evaporador_06_ensayo,df_valvula_expansion_07_ensayo):
    ...
    if df_equipo_estacionario.loc[inicio,'Rele compresor (on/off)']!=0 and df_equipo_estacionario.loc[inicio,'Apertura valvula by-pass (%)']<10:
...
#ANÁLISIS COMPLETO DEL CICLO
        ...
        st.warning('Análisis no disponibles (compresor desactivado o válvula de by-pass abierta) ')
