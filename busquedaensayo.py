...
def ensayo(ensayo_seleccionado,lista_ensayos,intervalos_ensayos,df_analizador_redes,df_equipo,df_evaporador_04,df_valvula_expansion_05,df_evaporador_06,df_valvula_expansion_07):
    ...
    #df_analizador_redes_ensayo.to_excel('ensayosdescargados/df1_2.xlsx')
    #df_equipo_ensayo.to_excel('ensayosdescargados/df2_2.xlsx')
    #df_evaporador_04_ensayo.to_excel('ensayosdescargados/df3_2.xlsx')
    #df_valvula_expansion_05_ensayo.to_excel('ensayosdescargados/df4_2.xlsx')
    #df_evaporador_06_ensayo.to_excel('ensayosdescargados/df5_2.xlsx')
    #df_valvula_expansion_07_ensayo.to_excel('ensayosdescargados/df6_2.xlsx')
